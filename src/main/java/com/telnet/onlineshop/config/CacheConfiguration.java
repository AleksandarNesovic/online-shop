package com.telnet.onlineshop.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("OnlineShop");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("OnlineShop");
        ...
        config.getMapConfigs().put("com.telnet.onlineshop.domain.*", initializeDomainMapConfig(jHipsterProperties));
